...
dataset = 'Luluaburg_1959'

# input: images
# where are located the images to process
image_folder = r"E:\PROCESS\SCANs\SCANS_Luluaburg\_Canvas_Sized"

# input: fiducial templates
# folder with the template images
fiducial_template_folder = r"C:\Users\adille\Desktop\Tests\SCANs\Fiducials_Barriere\Luluaburg_1959\Fiducial_templates_Luluaburg_1959"
...
if __name__ == "__main__":
    main_script_02(image_folder, fiducial_template_folder,
                   dataset, p, black_stripe_location)
