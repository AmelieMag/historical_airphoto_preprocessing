...
if __name__ == "__main__":
    ...
    entry_input_folder = tk.Button(root,text="Select folder",command=lambda: find_input_folder(entry_input_images,"Select aerial image folder")).grid(row=3,column=9, sticky="w")
    entry_output_folder = tk.Button(root,text="Select folder",command=lambda: find_output_folder(entry_output_images,"Select output directory")).grid(row=6,column=9, sticky="w")
    entry_template_folder = tk.Button(root,text="Select folder",command=lambda: find_template_folder(entry_fidu,"Select template directory")).grid(row=10,column=9, sticky="w")
